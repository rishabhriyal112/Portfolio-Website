...
export default function App() {
  ...
  return (
    <div className="bg-gray-50 font-sans antialiased">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-lg shadow-lg z-50 transition-all duration-300">
              ...
              <div className="relative group">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-600 via-indigo-500 to-purple-600 p-[2px] shadow-lg transform group-hover:scale-105 transition-transform duration-200">
                  <div className="w-full h-full rounded-full bg-white flex items-center justify-center relative overflow-hidden">
                    <span className="text-base font-extrabold font-graffiti bg-clip-text text-transparent bg-gradient-to-br from-indigo-600 to-purple-600" 
                          style={{
            ...
            <div className="hidden md:flex items-center space-x-8">
              {sections.map(section => (
                <button
                  ...
                  className={`text-gray-600 hover:text-indigo-600 capitalize font-medium transition-colors duration-300
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {sections.map(section => (
                <button
                  key={section}
                  onClick={() => scrollToSection(section)}
                  className="block px-3 py-2 text-base font-medium text-gray-600 hover:text-indigo-600 hover:bg-gray-50 w-full text-left capitalize"
                >
                  {section}
                </button>
              ))}
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen pt-16 flex items-center relative">
        {/* Background Pattern */}
            ...
            <div className="text-left space-y-8 animate-fade-in order-2 md:order-1">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="px-8 py-3 rounded-full bg-indigo-600 text-white font-medium hover:bg-indigo-700 transform hover:scale-105 transition-all duration-200"
                >
                  View My Work
                </button>
                <a
                  ...
                  className="px-8 py-3 rounded-full border-2 border-indigo-600 text-indigo-600 font-medium hover:bg-indigo-50 transform hover:scale-105 transition-all duration-200"
                >
                  Download CV
                </a>
              </div>
              <div className="flex items-center justify-center mr-105 gap-6 mt-8">
                <a
      ...
      <section id="about" className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-10 text-xl text-gray-600 max-w-4xl mx-auto space-y-8 bg-white rounded-2xl shadow-xl p-12 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              <p>
                A passionate and curious B.Tech Computer Science student specializing in AI & ML, with hands-on experience
                in building web applications using React and integrating machine learning models into real-world projects.
              </p>
              <p>
                Proficient in Python, JavaScript, and core data handling libraries like NumPy and Pandas.
                Continuously learning and experimenting through side projects, hackathons, and open-source contributions.
              </p>
            </div>
          </div>
        </div>
              ...
              {[
                {
                  name: 'React',
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-8 h-8 mb-3 text-blue-500">
                ...
                },
                {
                  name: 'JavaScript',
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-8 h-8 mb-3 text-yellow-400">
                ...
                },
                {
                  name: 'Python',
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-8 h-8 mb-3 text-blue-600">
                ...
                },
                {
                  ...
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-8 h-8 mb-3 text-green-500">
                      <path fill="currentColor" d="M12,16A3,3 0 0,1 9,13C9,11.88 9.61,10.9 10.5,10.39L20.21,4.77L14.68,14.35C14.18,15.33 13.17,16 12,16M12,3C7.03,3 3,7.03 3,12C3,16.97 7.03,21 12,21C16.97,21 21,16.97 21,12C21,7.03 16.97,3 12,3M12,19C8.13,19 5,15.87 5,12C5,8.13 8.13,5 12,5C15.87,5 19,8.13 19,12C19,15.87 15.87,19 12,19M12,7C9.24,7 7,9.24 7,12C7,14.76 9.24,17 12,17C14.76,17 17,14.76 17,12C17,9.24 14.76,7 12,7Z"/>
                    </svg>
                  )
                },
                {
                  name: 'HTML/CSS',
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-8 h-8 mb-3 text-orange-500">
                ...
                },
                {
                  name: 'Git',
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-8 h-8 mb-3 text-red-500">
                ...
                },
                {
                  name: 'REST APIs',
                  icon: (
                    <svg viewBox="0 0 24 24" className="w-8 h-8 mb-3 text-purple-500">
                ...
                <div
                  key={skill.name}
                  className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group"
                >
                  <div className="flex flex-col items-center">
                    {skill.icon}
                    <h3 className="text-lg font-semibold text-gray-800 group-hover:text-indigo-600 transition-colors duration-300">{skill.name}</h3>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-10 relative max-w-4xl mx-auto">
              ...
              <div className="space-y-16">
                ...
                <div className="relative">
                  ...
                  <div className="md:ml-12">
                    <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <span className="text-indigo-600 text-lg font-semibold">2020 - 2026</span>
                      <h3 className="text-2xl font-bold text-gray-800 mt-3">Swami Rama Himalayan University</h3>
                      <p className="text-xl text-gray-600 mt-3">B.Tech CSE with AI/ML</p>
                ...
                <div className="relative">
                  ...
                  <div className="md:ml-12">
                    <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <span className="text-indigo-600 text-lg font-semibold">Class 12</span>
                      <h3 className="text-2xl font-bold text-gray-800 mt-3">SBM Public School</h3>
                ...
                <div className="relative">
                  ...
                  <div className="md:ml-12">
                    <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <span className="text-indigo-600 text-lg font-semibold">Class 10</span>
                      <h3 className="text-2xl font-bold text-gray-800 mt-3">SBM Public School</h3>
                      <div className="mt-4 inline-block px-4 py-2 bg-indigo-50 rounded-full">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300">
                <div className="text-left">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Building Modern Websites</h3>
                  <p className="text-gray-600">Passionate about creating interactive UI experiences with React.js and integrating ML models into web applications.</p>
                </div>
              </div>
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300">
                <div className="text-left">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Developing and Training ML Models</h3>
                  <p className="text-gray-600">Enthusiastic about implementing machine learning algorithms and exploring new AI technologies.</p>
                </div>
              </div>
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300">
                <div className="text-left">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Participating in Coding Contests</h3>
                  <p className="text-gray-600">Regular participant in hackathons and coding competitions to enhance problem-solving skills.</p>
                </div>
              </div>
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300">
                <div className="text-left">
                  <h3 className="text-xl font-bold text-gray-800 mb-4">Tech Blogging & Learning New Frameworks</h3>
                  <p className="text-gray-600">Sharing knowledge through technical writing and continuously exploring emerging technologies.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Built An e-commerce website enables users to browse, search, and purchase products online through a digital storefront. It typically includes features like a homepage , product listings , shopping cart , and checkout process . Frontend-only e-commerce sites focus on user experience and UI interactivity using technologies like ReactJS and Tailwind CSS',
                ...
                },
                {
                  ...
                  description: 'Built a ML model using TensorFlow to detect diabetic retinopathy from retinal images.Implemented a complete image preprocessing pipeline including resizing, normalization, and augmentation.Trained and evaluated the model on labeled datasets, achieving high classification accuracy across severity levels',
                  image: 'https://images.pexels.com/photos/4124335/pexels-photo-4124335.jpeg',
                ...
                >
                  ...
                  <div className="p-6 flex-grow">
                    <h3 className="text-xl font-semibold text-gray-800 mb-2 text-left">{project.title}</h3>
            ...
            <div className="mt-10 max-w-2xl mx-auto space-y-8">
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-bold text-gray-800 mb-2">React & JavaScript</h3>
                    <p className="text-gray-600 mb-4">Comprehensive certification in modern web development with React and JavaScript.</p>
                    <a
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-gray-600 mb-4">Advanced certification in Generative AI and its applications in modern technology.</p>
                    <a
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-bold text-gray-800 mb-2">Data Visualization</h3>
                    <p className="text-gray-600 mb-4">Professional certification in data visualization techniques and best practices.</p>
                    <a
      ...
      <section id="contact" className="py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-10 max-w-xl mx-auto bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-shadow duration-300">
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-4 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-700 transform hover:scale-105 transition-all duration-200 hover:shadow-lg"
                >
                  Send Message
                </button>
              </form>
              <div className="mt-12 flex justify-center space-x-6">
                <a href="https://github.com/rishabhriyal112" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-indigo-600 transition-colors duration-200">
                  <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61-.546-1.385-1.335-1.755-1.335-1.755-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 .84-.27 2.75 1.02A9.56 9.56 0 0112 7.5c.85.004 1.71.115 2.51.337 1.91-1.29 2.75-1.02 2.75-1.02.55 1.38.2 2.4.1 2.65.64.7 1.03 1.59 1.03 2.68 0 3.83-2.34 4.68-4.57 4.93.36.31.68.92.68 1.85v2.74c0 .27.16.58.67.48A10.01 10.01 0 0022 12c0-5.52-4.48-10-10-10z" /></svg>
                </a>
                <a href="https://www.linkedin.com/in/rishabh-riyal-6a1567323/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-indigo-600 transition-colors duration-200">
                  <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                </a>
                <a href="mailto:riyalrishabh22@gmail.com" className="text-gray-400 hover:text-indigo-600 transition-colors duration-200">
                  <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
                </a>
              </div>
            </div>
          </div>
